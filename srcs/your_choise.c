...
int		*your_choise(t_folder **stack_a, t_folder **stack_b, t_num *ssl)
{
	...
	ra(stack_a);
	sb(stack_b);
	sum[3] = sum_position(stack_a, sort_a(stack_a, ssl), ssl->count_a) +
			sum_position(stack_b, sort_b(stack_b, ssl), ssl->count_b);
	sb(stack_b);
	ss(stack_a, stack_b);
	sum[4] = sum_position(stack_a, sort_a(stack_a, ssl), ssl->count_a) +
			sum_position(stack_b, sort_b(stack_b, ssl), ssl->count_b);
	ss(stack_a, stack_b);
	rb(stack_b);
	sum[5] = sum_position(stack_a, sort_a(stack_a, ssl), ssl->count_a) +
			sum_position(stack_b, sort_b(stack_b, ssl), ssl->count_b);
	rrb(stack_b);
	rr(stack_a, stack_b);
	sum[6] = sum_position(stack_a, sort_a(stack_a, ssl), ssl->count_a) +
			sum_position(stack_b, sort_b(stack_b, ssl), ssl->count_b);
	rrr(stack_a, stack_b);
	rrb(stack_b);
	sum[7] = sum_position(stack_a, sort_a(stack_a, ssl), ssl->count_a) +
			sum_position(stack_b, sort_b(stack_b, ssl), ssl->count_b);
	rb(stack_b);
	rrr(stack_a, stack_b);
	sum[8] = sum_position(stack_a, sort_a(stack_a, ssl), ssl->count_a) +
			sum_position(stack_b, sort_b(stack_b, ssl), ssl->count_b);
	rr(stack_a, stack_b);
