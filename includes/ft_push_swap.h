...
/*   Updated: 2019/12/17 23:19:44 by avenonat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						*your_choise(t_folder **stack_a, t_folder **stack_b,
						t_num *ssl);
int						*your_choise_minor(t_folder **stack_a,
						t_folder **stack_b, t_num *ssl);
int						search_min(int *sum);
int						search_minor(int *sum);
void					ask_function(t_folder **stack_a, t_folder **stack_b,
						int j, t_num *ssl);
int						your_choise2(t_folder **stack_a, t_folder **stack_b,
						t_num *ssl);
int						sum_position(t_folder **stack_a, int *good, int count);
int						move_b(t_folder **stack_a, t_folder **stack_b,
						t_num *ssl);
int						prepare_move_pb(t_folder **s_a, t_folder **s_b,
						t_num *ssl);
...
int						sum_position_checker(t_folder **stack_a, int *good,
						int count);
